 ...
 */
public class VehiculoTerrestre extends Vehiculo implements Serializable{
    

    public VehiculoTerrestre(boolean gasolina, boolean funcionamotor, String matricula, String Tipo) {
